...
// NewAddUserUsingPOSTParams creates a new AddUserUsingPOSTParams object
// with the default values initialized.
func NewAddUserUsingPOSTParams() AddUserUsingPOSTParams {
	var ()
	return AddUserUsingPOSTParams{}
}
...
func (o *AddUserUsingPOSTParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
