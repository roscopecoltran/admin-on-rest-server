...
// NewFindUserUsingGETParams creates a new FindUserUsingGETParams object
// with the default values initialized.
func NewFindUserUsingGETParams() FindUserUsingGETParams {
	var ()
	return FindUserUsingGETParams{}
}
...
func (o *FindUserUsingGETParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
